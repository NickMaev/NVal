...
var NVal = (function () {
    function NVal(htmlFormElement) {
        this.fields = [];
        this.ruleSearchList = ruleSearchList.slice();
        this.eventFunctions = [];
    ...
    NVal.prototype.initFields = function (htmlFormElement) {
        ...
        var self = this;
        this.fields = [];
        fieldTagTypeList.forEach(function (tagType) {
            var _a;
    ...
    NVal.prototype.assignExistingRule = function (htmlElement, ruleName, errorMessage) {
        ...
        var fieldTagType = fieldTagTypeList.filter(function (x) { return x.tag === inputTag; })[0];
